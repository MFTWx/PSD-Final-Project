    ...
    public partial class OrderSupplement : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response<List<MsCart>> cartResponse = CartHandler.getAllCarts(UserID);
        ...
        protected void GridOrderSupplement_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            if (response.Success == true)
            {
                ...
                Response<MsCart> cart = CartHandler.Create(UserID, SupplementID, quantity);
        ...
        protected void BtnClear_Click(object sender, EventArgs e)
        {
            ...
            int UserID = AuthHandler.getUserID(temp);
            Response<List<MsCart>> clear = CartHandler.clearCart(UserID);
        ...
        protected void BtnCheckout_Click(object sender, EventArgs e)
        {
            ...
            Response<TransactionHeader> header = TransactionsHandler.CreateHeader(UserID, "Unhandled");
            ...
            if (header.Success == true)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    Response<TransactionDetail> detail = TransactionsHandler.CreateDetail(transactionID, cartResponse.Payload[i].SupplementID, cartResponse.Payload[i].Quantity);
